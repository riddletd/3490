...
%    final sorted list.
mrgsort(Unsorted, Sorted) :-
    write('Splitting...'), split(Unsorted, L1, L2), write('done.'), nl,
    write('Recursing on half...'), mrgsort(L1, SortedL1), write('done.'), nl,
    write('Recursing on other half...'), mrgsort(L2, SortedL2), write('done.'), nl,
    write('Merging sorted halves...'), merge(SortedL1, SortedL2, Sorted), write('done.'), nl.
